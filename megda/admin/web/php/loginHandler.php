		...
		if($row=mysqli_fetch_assoc($result)){
    		if(password_verify($password, $row['password'])){
                ...
                if($resultCheck_usrRole < 1){
					...
					setcookie("dashboard_access",$row_usrRole['dashboard'],time()+86400,'/');
					setcookie("user_access",$row_usrRole['user'],time()+86400,'/');
					setcookie("products_access",$row_usrRole['products'],time()+86400,'/');
					setcookie("categories_access",$row_usrRole['categories'],time()+86400,'/');
					setcookie("settings_access",$row_usrRole['settings'],time()+86400,'/');
					setcookie("orders_access",$row_usrRole['orders'],time()+86400,'/');
					setcookie("customers_access",$row_usrRole['customers'],time()+86400,'/');
					setcookie("delivery_access",$row_usrRole['delivery'],time()+86400,'/');
					setcookie("inventory_access",$row_usrRole['inventory'],time()+86400,'/');
					setcookie("reports_access",$row_usrRole['reports'],time()+86400,'/');					
