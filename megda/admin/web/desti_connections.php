            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Connection Administration</h4>
                    </div>
            ...
            <div class="container-fluid">
      				...
      				<div class="col-12">
      					<div class="card"><div class="card-body">
							<ul class="nav nav-tabs" role="tablist">
    							<li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#entities" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">Database</span></a> </li>
    							<li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#sourcedb" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">FileSystem</span></a> </li>
    							<li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#rest" role="tab"><span class="hidden-sm-up"><i class="ti-email"></i></span> <span class="hidden-xs-down">CloudStorage</span></a> </li>
							</ul>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Database details are required to store the archieved records for a Rule. <a href="https://datatables.net/"> Database Connections </a></h6>
                                    ...
                                    <div class="row border-bottom">
                                        ...
                                        <div class="col-sm-12 col-lg-12">
                                            <div class="form-group row align-items-center m-b-0">
                                                ...
                                                <div class="col-9 border-left p-t-10 p-b-10">
                                                    <input type="text" class="form-control" id="system_details" placeholder="System Details" value = "pdb1.us.oracle.com">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row border-bottom">
                                        <div class="col-sm-12 col-lg-12">
                                            <div class="form-group row align-items-center m-b-0">
                                                ...
                                                <div class="col-9 border-left p-t-10 p-b-10">
                                                    <input type="text" class="form-control" id="system_name" placeholder="System Name" value = "(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=10.65.46.55)(PORT=1521))(CONNECT_DATA=(SERVER=DEDICATED)(SERVICE_NAME=pdb1.us.oracle.com)))">
                                                </div>
                                            </div>
                                        </div>
                                    </div>                                                
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">File System Path Details</h4>
                                <h6 class="card-subtitle">File System path to be specified here. This archived files are stored in this location. Appropriate permissions are required <a href="https://datatables.net/"> File System Path Connections </a></h6>
                                <div class="card-body bg-light">
                                    <div class="row border-bottom">
                                        
                                        <div class="col-sm-12 col-lg-12">
                                            <div class="form-group row align-items-center m-b-0">
                                                <label for="system_details" class="col-3 text-right control-label col-form-label">File System Path</label>
                                                <div class="col-9 border-left p-t-10 p-b-10">
                                                    <input type="text" class="form-control" id="system_details" placeholder="System Details" value = "/opt/megda/archive">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Cloud Storage Details</h4>
                                <h6 class="card-subtitle">Cloud Storage details needs to be provided.Currently OCI Object Storage is preffered way for cloud storage. <a href="https://datatables.net/"> OCI Object Storage Details </a></h6>
                                <div class="card-body bg-light">
                                    <div class="row border-bottom">
                                        <div class="col-sm-12 col-lg-12">
                                            <div class="form-group row align-items-center m-b-0">
                                                <label for="REST_endpoint" class="col-3 text-right control-label col-form-label">OCI Region</label>
                                                <div class="col-9 border-left p-t-10 p-b-10">
                                                    <input type="text" class="form-control" id="REST_endpoint" placeholder="REST End point for Query" value = "ap-hyderabad-1">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row border-bottom">
                                        <div class="col-sm-12 col-lg-12">
                                            <div class="form-group row align-items-center m-b-0">
                                                <label for="REST_endpoint_delete" class="col-3 text-right control-label col-form-label">Tenancy</label>
                                                <div class="col-9 border-left p-t-10 p-b-10">
                                                    <input type="text" class="form-control" id="REST_endpoint_delete" placeholder="REST End point for Delete" value = "tenancy=ocid1.tenancy.oc1..aaaaaaaa6qf3pcimu7kbihsgyghqtqeq64rtsyfcmupovh7ixk5lmh2bsfoa">
                                                </div>
                                            </div>
                                        </div>
                                    </div>                                                 
                                    <div class="row border-bottom">
                                        <div class="col-sm-12 col-lg-12">
                                            <div class="form-group row align-items-center m-b-0">
                                                <label for="REST_endpoint_delete" class="col-3 text-right control-label col-form-label">Namespace</label>
                                                <div class="col-9 border-left p-t-10 p-b-10">
                                                    <input type="text" class="form-control" id="REST_endpoint_delete" placeholder="REST End point for Delete" value = "axztm1exotmj">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row border-bottom">
                                        <div class="col-sm-12 col-lg-12">
                                            <div class="form-group row align-items-center m-b-0">
                                                <label for="REST_endpoint_delete" class="col-3 text-right control-label col-form-label">Bucket Name</label>
                                                <div class="col-9 border-left p-t-10 p-b-10">
                                                    <input type="text" class="form-control" id="REST_endpoint_delete" placeholder="REST End point for Delete" value = "megda-archive-bucket">
                                                </div>
                                            </div>
                                        </div>
                                    </div>   
